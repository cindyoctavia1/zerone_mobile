...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // AppBar yang dibungkus dalam Container untuk menambahkan bayangan.
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(56.0), // Ukuran tinggi AppBar
        child: Container(
...
class InfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      elevation: 2.0,
      shadowColor: Colors.grey.withOpacity(0.5), // Warna bayangan dengan transparansi
